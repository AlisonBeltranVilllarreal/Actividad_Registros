...
c.execute('''CREATE TABLE IF NOT EXISTS acciones
             (nombre TEXT, apellido_paterno TEXT, apellido_materno TEXT, correo TEXT, movil TEXT, ocupacion TEXT, leer TEXT, musica TEXT, videojuegos TEXT, estado TEXT)''')
...
def GuardarDatos():
    ...
    c.execute("INSERT INTO acciones VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
              (personita.nombre, personita.apellido_paterno, personita.apellido_materno, personita.correo, personita.movil, personita.ocupacion, personita.leer, personita.musica, personita.videojuegos, personita.estado))
